...
typedef dr_bool32     (* dred_package_delete_editor_proc)     (dred_package* pPackage, dred_context* pDred, dred_editor* pEditor);   // <-- Return value is DR_TRUE if the editor was deleted; DR_FALSE if the editor was not created by this package.

// Command line functions.
typedef dr_bool32 (* dred_package_try_exec_cmdline_func_proc)(dred_package* pPackage, int argc, char** argv, int* pResult);
