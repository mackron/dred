...
#define DRED_STOCK_IMAGE_COUNT 4
#define DRED_STOCK_IMAGE_ID_CROSS 1
#define DRED_STOCK_IMAGE_ID_ARROW_RIGHT 2
#define DRED_STOCK_IMAGE_ID_ARROW_RIGHT_DOWN 3
#define DRED_STOCK_IMAGE_ID_LOGO 4
