...
dr_bool32 dred_init(dred_context* pDred, dr_cmdline cmdline, dred_package_library* pPackageLibrary)
{
    ...
    // Shortcut table.
    if (!dred_shortcut_table_init(pDred, &pDred->shortcutTable)) {
        goto on_error;
    }

    //dred_bind_default_shortcuts__autogenerated(pDred);

#if 1
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_NEW,        dred_shortcut_create_single(dtk_accelerator_init('N', DRED_KEY_STATE_CTRL_DOWN, 0)), "new");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_OPEN,       dred_shortcut_create_single(dtk_accelerator_init('O', DRED_KEY_STATE_CTRL_DOWN, 0)), "open");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_SAVE,       dred_shortcut_create_single(dtk_accelerator_init('S', DRED_KEY_STATE_CTRL_DOWN, 0)), "save");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_SAVE_ALL,   dred_shortcut_create_single(dtk_accelerator_init('S', DRED_KEY_STATE_CTRL_DOWN | DRED_KEY_STATE_SHIFT_DOWN, 0)), "save-all");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_CLOSE,      dred_shortcut_create_single(dtk_accelerator_init('W', DRED_KEY_STATE_CTRL_DOWN, 0)), "close");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_CLOSE_ALL,  dred_shortcut_create_single(dtk_accelerator_init('W', DRED_KEY_STATE_CTRL_DOWN | DRED_KEY_STATE_SHIFT_DOWN, 0)), "close-all");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_PRINT,      dred_shortcut_create_single(dtk_accelerator_init('P', DRED_KEY_STATE_CTRL_DOWN, 0)), "print");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_UNDO,       dred_shortcut_create_single(dtk_accelerator_init('Z', DRED_KEY_STATE_CTRL_DOWN, 0)), "undo");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_REDO,       dred_shortcut_create_single(dtk_accelerator_init('Y', DRED_KEY_STATE_CTRL_DOWN, 0)), "redo");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_CUT,        dred_shortcut_create_single(dtk_accelerator_init('X', DRED_KEY_STATE_CTRL_DOWN, 0)), "cut");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_COPY,       dred_shortcut_create_single(dtk_accelerator_init('C', DRED_KEY_STATE_CTRL_DOWN, 0)), "copy");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_PASTE,      dred_shortcut_create_single(dtk_accelerator_init('V', DRED_KEY_STATE_CTRL_DOWN, 0)), "paste");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_SELECT_ALL, dred_shortcut_create_single(dtk_accelerator_init('A', DRED_KEY_STATE_CTRL_DOWN, 0)), "select-all");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_UNINDENT,   dred_shortcut_create_single(dtk_accelerator_init('\t', DRED_KEY_STATE_SHIFT_DOWN, 0)), "unindent");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_GOTO,       dred_shortcut_create_single(dtk_accelerator_init('G', DRED_KEY_STATE_CTRL_DOWN, 0)), "cmdbar goto ");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_FIND,       dred_shortcut_create_single(dtk_accelerator_init('F', DRED_KEY_STATE_CTRL_DOWN, 0)), "cmdbar find ");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_REPLACE,    dred_shortcut_create_single(dtk_accelerator_init('F', DRED_KEY_STATE_CTRL_DOWN | DRED_KEY_STATE_SHIFT_DOWN, 0)), "cmdbar replace-all ");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_NEXT_TAB,   dred_shortcut_create_single(dtk_accelerator_init('\t', DRED_KEY_STATE_CTRL_DOWN, 0)), "next-tab");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_PREV_TAB,   dred_shortcut_create_single(dtk_accelerator_init('\t', DRED_KEY_STATE_CTRL_DOWN | DRED_KEY_STATE_SHIFT_DOWN, 0)), "prev-tab");
    dred_bind_shortcut(pDred, DRED_SHORTCUT_NAME_RELOAD,     dred_shortcut_create_single(dtk_accelerator_init(DRED_GUI_F5, 0, 0)), "reload");
#endif
...
void dred_show_menu_bar(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "show-menu-bar", "DR_TRUE");
}
...
void dred_hide_menu_bar(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "show-menu-bar", "DR_FALSE");
}
...
void dred_show_tabbars(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "show-tab-bar", "DR_TRUE");
}
...
void dred_hide_tabbars(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "show-tab-bar", "DR_FALSE");
}
...
void dred_show_line_numbers(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "texteditor-show-line-numbers", "DR_TRUE");
}
...
void dred_hide_line_numbers(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "texteditor-show-line-numbers", "DR_FALSE");
}
...
void dred_enable_word_wrap(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "texteditor-enable-word-wrap", "DR_TRUE");
}
...
void dred_disable_word_wrap(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "texteditor-enable-word-wrap", "DR_FALSE");
}
...
void dred_enable_auto_hide_command_bar(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "auto-hide-cmd-bar", "DR_TRUE");
}
...
void dred_disable_auto_hide_command_bar(dred_context* pDred)
{
    ...
    dred_set_config_variable(pDred, "auto-hide-cmd-bar", "DR_FALSE");
}
