...
{
    return dtk_control_get_absolute_rect(DTK_CONTROL(pControl));
}

dtk_rect dred_control_get_relative_rect(const dred_control* pControl)
{
    return dtk_control_get_relative_rect(DTK_CONTROL(pControl));
}

dtk_rect dred_control_get_local_rect(const dred_control* pControl)
{
    return dtk_control_get_local_rect(DTK_CONTROL(pControl));
}
