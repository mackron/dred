...
int main(int argc, char** argv)
{
    ...
    fwrite_string(pFileOut, "// Copyright (C) 2018 David Reid. See included LICENSE file.\n\n");
    ...
    fwrite_string(pFileOutH, "// Copyright (C) 2018 David Reid. See included LICENSE file.\n\n");
