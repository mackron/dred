...
#include "../../source/external/stretchy_buffer.h"
...
int main(int argc, char** argv)
{
    ...
    fwrite_string(pFileOut, "// Copyright (C) 2016 David Reid. See included LICENSE file.\n\n");
    ...
    fwrite_string(pFileOutH, "// Copyright (C) 2016 David Reid. See included LICENSE file.\n\n");
    fwrite_string(pFileOutH, "// This file was automatically generated by the pre-build tool. Do not modify.\n\n");

    // External libraries.
    dr_copy_file("../../../../../dr_libs/dr.h", "../../../source/external/dr.h", false);
    dr_copy_file("../../../../dr_ipc/dr_ipc.h", "../../../source/external/dr_ipc.h", false);
