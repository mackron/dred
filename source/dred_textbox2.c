...
typedef struct
{
    ...
    dred_textbox2_on_cursor_move_proc onCursorMove;

    /// The function to call when the undo point changes.
    dred_textbox2_on_undo_point_changed_proc onUndoPointChanged;
...
void dred_textbox2__get_text_offset(dred_textbox2* pTextBox, float* pOffsetXOut, float* pOffsetYOut);

/// Calculates the required size of the text engine.
void dred_textbox2__calculate_text_engine_container_size(dred_textbox2* pTextBox, float* pWidthOut, float* pHeightOut);

/// Retrieves the rectangle of the text engine's container.
drgui_rect dred_textbox2__get_text_rect(dred_textbox2* pTextBox);

/// Refreshes the range, page sizes and layouts of the scrollbars.
void dred_textbox2__refresh_scrollbars(dred_textbox2* pTextBox);

/// Refreshes the range and page sizes of the scrollbars.
void dred_textbox2__refresh_scrollbar_ranges(dred_textbox2* pTextBox);

/// Refreshes the size and position of the scrollbars.
void dred_textbox2__refresh_scrollbar_layouts(dred_textbox2* pTextBox);

/// Retrieves a rectangle representing the space between the edges of the two scrollbars.
drgui_rect dred_textbox2__get_scrollbar_dead_space_rect(dred_textbox2* pTextBox);


/// Called when a mouse button is pressed on the line numbers element.
void dred_textbox2__on_mouse_move_line_numbers(drgui_element* pLineNumbers, int relativeMousePosX, int relativeMousePosY, int stateFlags);

/// Called when a mouse button is pressed on the line numbers element.
void dred_textbox2__on_mouse_button_down_line_numbers(drgui_element* pLineNumbers, int mouseButton, int relativeMousePosX, int relativeMousePosY, int stateFlags);

/// Called when a mouse button is pressed on the line numbers element.
void dred_textbox2__on_mouse_button_up_line_numbers(drgui_element* pLineNumbers, int mouseButton, int relativeMousePosX, int relativeMousePosY, int stateFlags);

/// Called when the line numbers element needs to be drawn.
void dred_textbox2__on_paint_line_numbers(drgui_element* pLineNumbers, drgui_rect relativeRect, void* pPaintData);

/// Refreshes the line number of the given text editor.
void dred_textbox2__refresh_line_numbers(dred_textbox2* pTextBox);


/// on_paint_rect()
void dred_textbox2__on_text_engine_paint_rect(drgui_text_engine* pLayout, drgui_rect rect, drgui_color color, dred_textbox2* pTextBox, void* pPaintData);

/// on_paint_text()
void dred_textbox2__on_text_engine_paint_text(drgui_text_engine* pTL, drgui_text_run* pRun, dred_textbox2* pTextBox, void* pPaintData);

/// on_dirty()
void dred_textbox2__on_text_engine_dirty(drgui_text_engine* pTL, drgui_rect rect);

/// on_cursor_move()
void dred_textbox2__on_text_engine_cursor_move(drgui_text_engine* pTL);

/// on_text_changed()
void dred_textbox2__on_text_engine_text_changed(drgui_text_engine* pTL);

/// on_undo_point_changed()
void dred_textbox2__on_text_engine_undo_point_changed(drgui_text_engine* pTL, unsigned int iUndoPoint);


void dred_textbox2__on_vscroll(drgui_element* pSBElement, int scrollPos)
{
    dred_textbox2* pTextBox = *(drgui_element**)drgui_sb_get_extra_data(pSBElement);
    assert(pTextBox != NULL);

    dred_textbox2_data* pTB = (dred_textbox2_data*)drgui_get_extra_data(pTextBox);
    assert(pTB != NULL);
...
void dred_textbox2__on_hscroll(drgui_element* pSBElement, int scrollPos)
{
    dred_textbox2* pTextBox = *(drgui_element**)drgui_sb_get_extra_data(pSBElement);
    assert(pTextBox != NULL);
...
dred_textbox2* dred_textbox2_create(dred_context* pDred, drgui_element* pParent)
{
    dred_textbox2* pTextBox = dred_control_create(pDred, pParent, DRED_CONTROL_TYPE_TEXTBOX, sizeof(dred_textbox2_data));
    if (pTextBox == NULL) {
        return NULL;
    }

    drgui_set_cursor(pTextBox, drgui_cursor_text);
    drgui_set_on_size(pTextBox, dred_textbox2_on_size);
    drgui_set_on_mouse_move(pTextBox, dred_textbox2_on_mouse_move);
    drgui_set_on_mouse_button_down(pTextBox, dred_textbox2_on_mouse_button_down);
    drgui_set_on_mouse_button_up(pTextBox, dred_textbox2_on_mouse_button_up);
    drgui_set_on_mouse_button_dblclick(pTextBox, dred_textbox2_on_mouse_button_dblclick);
    drgui_set_on_mouse_wheel(pTextBox, dred_textbox2_on_mouse_wheel);
    drgui_set_on_key_down(pTextBox, dred_textbox2_on_key_down);
    drgui_set_on_printable_key_down(pTextBox, dred_textbox2_on_printable_key_down);
    drgui_set_on_paint(pTextBox, dred_textbox2_on_paint);
    drgui_set_on_capture_keyboard(pTextBox, dred_textbox2_on_capture_keyboard);
    drgui_set_on_release_keyboard(pTextBox, dred_textbox2_on_release_keyboard);
    drgui_set_on_capture_mouse(pTextBox, dred_textbox2_on_capture_mouse);
    drgui_set_on_release_mouse(pTextBox, dred_textbox2_on_release_mouse);

    dred_textbox2_data* pTB = (dred_textbox2_data*)drgui_get_extra_data(pTextBox);
    assert(pTB != NULL);

    pTB->pVertScrollbar = drgui_create_scrollbar(pDred->pGUI, pTextBox, drgui_sb_orientation_vertical, sizeof(pTextBox), &pTextBox);
    drgui_sb_set_on_scroll(pTB->pVertScrollbar, dred_textbox2__on_vscroll);
    ...
    drgui_sb_set_on_scroll(pTB->pHorzScrollbar, dred_textbox2__on_hscroll);

    pTB->pLineNumbers = drgui_create_element(pDred->pGUI, pTextBox, sizeof(pTextBox), &pTextBox);
    drgui_hide(pTB->pLineNumbers);
    drgui_set_on_mouse_move(pTB->pLineNumbers, dred_textbox2__on_mouse_move_line_numbers);
    drgui_set_on_mouse_button_down(pTB->pLineNumbers, dred_textbox2__on_mouse_button_down_line_numbers);
    drgui_set_on_mouse_button_up(pTB->pLineNumbers, dred_textbox2__on_mouse_button_up_line_numbers);
    drgui_set_on_paint(pTB->pLineNumbers, dred_textbox2__on_paint_line_numbers);
    ...
    drgui_text_engine_set_on_paint_rect(pTB->pTL, dred_textbox2__on_text_engine_paint_rect);
    drgui_text_engine_set_on_paint_text(pTB->pTL, dred_textbox2__on_text_engine_paint_text);
    drgui_text_engine_set_on_dirty(pTB->pTL, dred_textbox2__on_text_engine_dirty);
    drgui_text_engine_set_on_cursor_move(pTB->pTL, dred_textbox2__on_text_engine_cursor_move);
    drgui_text_engine_set_on_text_changed(pTB->pTL, dred_textbox2__on_text_engine_text_changed);
    drgui_text_engine_set_on_undo_point_changed(pTB->pTL, dred_textbox2__on_text_engine_undo_point_changed);
...
void dred_textbox2_set_font(dred_textbox2* pTextBox, drgui_font* pFont)
{
    ...
    drgui_begin_dirty(pTextBox);
    {
        ...
        dred_textbox2__refresh_line_numbers(pTextBox);

        // Emulate a scroll to ensure the scroll position is pinned to a line.
        dred_textbox2__on_vscroll(pTB->pVertScrollbar, drgui_sb_get_scroll_position(pTB->pVertScrollbar));
        dred_textbox2__refresh_scrollbars(pTextBox);
...
void dred_textbox2_on_size(dred_textbox2* pTextBox, float newWidth, float newHeight)
{
    ...
    dred_textbox2__calculate_text_engine_container_size(pTextBox, &containerWidth, &containerHeight);
...
void dred_textbox2_on_mouse_move(dred_textbox2* pTextBox, int relativeMousePosX, int relativeMousePosY, int stateFlags)
{
    ...
    if (drgui_get_element_with_mouse_capture(pTextBox->pContext) == pTextBox)
    {
        float offsetX;
        float offsetY;
        dred_textbox2__get_text_offset(pTextBox, &offsetX, &offsetY);
...
void dred_textbox2__on_text_engine_paint_rect(drgui_text_engine* pTL, drgui_rect rect, drgui_color color, dred_textbox2* pTextBox, void* pPaintData)
{
    (void)pTL;
...
void dred_textbox2__on_text_engine_dirty(drgui_text_engine* pTL, drgui_rect rect)
{
    dred_textbox2* pTextBox = *(drgui_element**)drgui_text_engine_get_extra_data(pTL);
    if (pTextBox == NULL) {
        return;
    }
...
void dred_textbox2_on_paint(dred_textbox2* pTextBox, drgui_rect relativeRect, void* pPaintData)
{
    ...
    drgui_rect textRect = dred_textbox2__get_text_rect(pTextBox);

    // The dead space between the scrollbars should always be drawn with the default background color.
    drgui_draw_rect(pTextBox, dred_textbox2__get_scrollbar_dead_space_rect(pTextBox), drgui_text_engine_get_default_bg_color(pTB->pTL), pPaintData);
...
void dred_textbox2__on_timer(dred_timer* pTimer, void* pUserData)
{
    (void)pTimer;

    dred_textbox2* pTextBox = (dred_textbox2*)pUserData;
    assert(pTextBox != NULL);

    dred_textbox2_data* data = (dred_textbox2_data*)dred_control_get_extra_data(pTextBox);
    assert(data != NULL);

    dred_textbox2_step(pTextBox, 100);
}
...
void dred_textbox2_on_capture_keyboard(dred_textbox2* pTextBox, drgui_element* pPrevCapturedElement)
{
    ...
    if (pTB->pTimer == NULL) {
        pTB->pTimer = dred_timer_create(100, dred_textbox2__on_timer, pTextBox);
    }
}
...
drgui_rect dred_textbox2__get_text_rect(dred_textbox2* pTextBox)
{
    ...
    float width;
    float height;
    dred_textbox2__calculate_text_engine_container_size(pTextBox, &width, &height);
...
void dred_textbox2__refresh_scrollbars(dred_textbox2* pTextBox)
{
    ...
    dred_textbox2__refresh_scrollbar_ranges(pTextBox);
    dred_textbox2__refresh_scrollbar_layouts(pTextBox);
    dred_textbox2__refresh_scrollbar_ranges(pTextBox);
}
...
void dred_textbox2__on_mouse_move_line_numbers(drgui_element* pLineNumbers, int relativeMousePosX, int relativeMousePosY, int stateFlags)
{
    ...
    dred_textbox2* pTextBox = *(drgui_element**)drgui_get_extra_data(pLineNumbers);
    assert(pTextBox != NULL);
...
void dred_textbox2__on_paint_rect_line_numbers(drgui_text_engine* pLayout, drgui_rect rect, drgui_color color, dred_textbox2* pTextBox, void* pPaintData)
{
    (void)pLayout;
...
void dred_textbox2__on_paint_text_line_numbers(drgui_text_engine* pLayout, drgui_text_run* pRun, dred_textbox2* pTextBox, void* pPaintData)
{
    (void)pLayout;
...
void dred_textbox2__on_paint_line_numbers(drgui_element* pLineNumbers, drgui_rect relativeRect, void* pPaintData)
{
    ...
    drgui_text_engine_paint_line_numbers(pTB->pTL, lineNumbersWidth, lineNumbersHeight, pTB->lineNumbersColor, pTB->lineNumbersBackgroundColor, dred_textbox2__on_paint_text_line_numbers, dred_textbox2__on_paint_rect_line_numbers, pTextBox, pPaintData);
...
void dred_textbox2__refresh_line_numbers(dred_textbox2* pTextBox)
{
    ...
    dred_textbox2__calculate_text_engine_container_size(pTextBox, &textEditorWidth, &textEditorHeight);
